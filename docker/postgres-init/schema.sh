...
(
    status      smallint     not null
        constraint user_detail_status_check
...
insert into user_detail (address, name, nationality, password, phone, roles, status, username)
values ('Address', 'Administrator', 'LB', '$2a$10$oFlfWd1UQ0lxbkLGq.XvEOHuH/J4ICOFB2qLsjRsbDFA2wjI26rDa', '81633729', 'ADMIN', 0, 'admin');

insert into user_detail (address, name, nationality, password, phone, roles, status, username)
values ('Address', 'Employee', 'LB', '$2a$10$oFlfWd1UQ0lxbkLGq.XvEOHuH/J4ICOFB2qLsjRsbDFA2wjI26rDa', '81633729', 'EMPLOYEE', 0, 'employee');


INSERT INTO dictionary (id, type, attribute, value, format, vendor, recommendedop, recommended_table, recommended_helper, recommended_tooltip)
VALUES (1,'ipaddr','AAT-Client-Primary-DNS',NULL,NULL,'Alcatel',NULL,NULL,NULL,NULL),
